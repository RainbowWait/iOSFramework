...
Pod::Spec.new do |spec|
  ...
  spec.homepage     = "https://github.com/RainbowWait/iOSFramework.git"
  ...
  spec.author             = { "小燕 郑" => "1136200379@qq.com" }
  # Or just: spec.author    = "小燕 郑"
  # spec.authors            = { "小燕 郑" => "1136200379@qq.com" }
  # spec.social_media_url   = "https://twitter.com/小燕 郑"
  ...
  spec.source       = { :git => "https://github.com/RainbowWait/iOSFramework.git", :tag => "1.0.0" }
